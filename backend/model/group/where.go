...
func HasStudents() predicate.Group {
...
func HasStudentsWith(preds ...predicate.User) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
...
// HasGroupRun applies the HasEdge predicate on the "group_run" edge.
func HasGroupRun() predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasGroupRunWith applies the HasEdge predicate on the "group_run" edge with a given conditions (other predicates).
func HasGroupRunWith(preds ...predicate.GroupRun) predicate.Group {
	return predicate.Group(func(s *sql.Selector) {
		step := newGroupRunStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
				p(s)
			}
